...
const Info = ({ stopsAmount, timeConvert, fromToTime, origin, destination, date, duration, stops }) =>
  <Row>
    <Col xs={4} sm={4} md={3} lg={4} xl={4}><UpperColText><Card.Text>{origin} - {destination}</Card.Text></UpperColText></Col>
    ...
    <Col xs={4} sm={4} md={3} lg={4} xl={4}><LowerColText><Card.Text>{fromToTime(date)}</Card.Text></LowerColText></Col>
