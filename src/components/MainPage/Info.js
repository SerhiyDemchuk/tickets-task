...
const Info = ({
  ...
  <Row>
    ...
    <StyledLowerCol xs={4} sm={3} md={4} lg={4} xl={4}>{displayTime(date, duration)}</StyledLowerCol>
    <StyledLowerCol xs={3} sm={4} md={3} lg={4} xl={4}>{displayTime(null, duration)}</StyledLowerCol>
